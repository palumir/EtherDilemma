class ChallengeView {
	...
	createChallengeButton(display) {
		...
		displayObj.append("<div>Ether Dilemma is a <a href='https://www.ethereum.org/'>simple Ethereum smart contract</a> based on the <a href='https://en.wikipedia.org/wiki/Prisoner%27s_dilemma'>Prisoner's Dilemma</a>, where each player pays 0.020 Ether to play, and can choose to either <div class='betray'><img src='/images/betray.png'>betray</div> or <div class='ally'><img src='/images/ally.png'>ally</div> with the other player:</div>");
		displayObj.append("<br><div>- If both players <div class='ally'><img src='/images/ally.png'>ally</div>, both players get rewarded &boxh; receiving 0.024 Ether</div>");
		...
		displayObj.append("<div>- If one player <div class='betray'><img src='/images/betray.png'>betrays</div> and the other <div class='ally'><img src='/images/ally.png'>cooperates</div> &boxh; the <div class='betray'><img src='/images/betray.png'>betrayer</div> gets 0.36 Ether and the <div class='ally'><img src='/images/ally.png'>cooperater</div> gets 0 Ether</div>");
		displayObj.append("<br><div>The game is usually fairly difficult to simulate in an interesting way, because there isn't actually anything of real value at stake. <br><br>That's where Ethereum and <a href='https://metamask.io/'>MetaMask</a> come in. Simply download <a href='https://metamask.io/'>MetaMask</a> as a browser extension and load up some <a href='https://en.wikipedia.org/wiki/Ether'>Ether</a> to play. <div class='ally'><img src='/images/ally.png'>ally</div>, and receive a reward, or risk it all by <div class='betray'><img src='/images/betray.png'>betraying</div> your opponent.</div>");
