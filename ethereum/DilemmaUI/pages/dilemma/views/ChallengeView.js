class ChallengeView {
	...
	createChallengeButton(display) {
		...
		middleSection += "<div id='thePayout' class='col-sm-12'><h4 class='col-lg-4 col-sm-12 left'><img src='images/thePayout.png' class='left'></h4><div class='payouts col-lg-8 col-sm-12 left'><div class='col-lg-4 col-sm-12 left'><img src='images/alliance.png' title='-20 from wager + 26 from bank = +6 net finney' class='left'></div><div class='col-lg-4 col-sm-12 left'><img src='images/betrayal.png' title='-20 from wager + 36 from bank = +16 net finney' class='left'></div><div class='col-lg-4 col-sm-12 left'><img src='images/duplicity.png' title='-20 from wager + 4 from bank = -16 net finney' class='left'></div><div class='col-lg-4 col-sm-12 left'><img src='images/mistrust.png' title='-20 from wager + 29 from bank = +9 net finney' class='left'></div><div class='col-lg-4 col-sm-12 left'><img src='images/revelation.png' title='-20 from wager + 23 from bank = +3 net finney' class='left'></div><div class='col-lg-4 col-sm-12 left'><img src='images/standoff.png' title='-20 from wager + 17 from bank = -3 net finney' class='left'></div></div></div>";
