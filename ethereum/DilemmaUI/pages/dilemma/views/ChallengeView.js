class ChallengeView {
	...
	createChallengeButton(display, metamaskReq = false) {
		...
		// If they already have MetaMask
		if(!metamaskReq) {
			// Prepend HTML
			if(dilemmaController.contractLocked) displayObj.append("<div id='bottomText'>The contract is currently locked, so playing is temporarily disabled. We apologize for the inconvenience.</div>");
