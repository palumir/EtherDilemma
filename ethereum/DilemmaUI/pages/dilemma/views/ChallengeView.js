class ChallengeView {
	...
	createChallengeButton(display) {
		...
		middleSection += "<div id='thePayout' class='col-sm-12'><h4 class='col-lg-4 col-sm-12 left'><img src='images/thePayout.png' class='left'></h4><div class='payouts col-lg-8 col-sm-12 left'><div class='col-lg-4 col-sm-12 left'><img src='images/alliance.png' class='left'></div><div class='col-lg-4 col-sm-12 left'><img src='images/betrayal.png' class='left'></div><div class='col-lg-4 col-sm-12 left'><img src='images/duplicity.png' class='left'></div></div></div>";
