...
class MoveView {
	...
	createInterface(display) {
			...
			if($('#moveSelector')[0]==undefined) {
				$("#" + display).append("<div id='moveSelector' class='col-sm-12' ><div class='selectable ally col-sm-6' value=0></div><div class='selectable betray col-sm-6' value=1></div><div class='selectable call col-sm-6' value=2>Call</div></div>");
